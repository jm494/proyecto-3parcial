...
CREATE TABLE `detalle_venta` (
  ...
  CONSTRAINT `detalle_venta_ibfk_2` FOREIGN KEY (`videojuego_id`) REFERENCES `videojuego` (`videojuego_id`),
  CONSTRAINT `detalle_venta_ibfk_3` FOREIGN KEY (`almacen_id`) REFERENCES `almacen` (`almacen_id`)
...
-- Dump completed on 2019-07-19  0:22:21
